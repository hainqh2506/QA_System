...
def initialize_model(selected_model):
    ...
    if selected_model == "Gemini1.5Flash":
        llm = load_gemini15()
    elif selected_model == "Together_ai.meta-llama/Llama-3.3-70B-Instruct-Turbo":
...
selected_model = st.sidebar.selectbox(
    "Chọn model",
    ["Gemini1.5Flash", "Together_ai.meta-llama/Llama-3.3-70B-Instruct-Turbo", "Groq_llama-3.3-70b-versatile", "GPT4o Mini"]
)
